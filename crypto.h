...
62  */
    63 64 #ifndef GPL_LICENSE_TERMS_ACCEPTED 65 #error Before compiling CycloneCRYPTO Open,
    you must accept the terms of the GPL license 66 #endif 67 68 //Version string
    69 #define CYCLONE_CRYPTO_VERSION_STRING "2.0.4" 70          //Major version
    71 #define CYCLONE_CRYPTO_MAJOR_VERSION 2 72                 //Minor version
    73 #define CYCLONE_CRYPTO_MINOR_VERSION 0 74                 //Revision number
    75 #define CYCLONE_CRYPTO_REV_NUMBER 4 76 77                 //Multiple precision integer support
    78 #ifndef MPI_SUPPORT 79 #define MPI_SUPPORT ENABLED 80 #elif (MPI_SUPPORT != ENABLED && MPI_SUPPORT != DISABLED) 81 #error MPI_SUPPORT parameter is not valid
    82 #endif
    83 84 //Assembly optimizations for time-critical routines
    85 #ifndef MPI_ASM_SUPPORT
    86 #define MPI_ASM_SUPPORT DISABLED
    87 #elif (MPI_ASM_SUPPORT != ENABLED && MPI_ASM_SUPPORT != DISABLED) 88 #error MPI_ASM_SUPPORT parameter is not valid
    89 #endif
    90 91 //Base64 encoding support
    92 #ifndef BASE64_SUPPORT
    93 #define BASE64_SUPPORT ENABLED
    94 #elif (BASE64_SUPPORT != ENABLED && BASE64_SUPPORT != DISABLED) 95 #error BASE64_SUPPORT parameter is not valid
    96 #endif
    97 98 //Base64url encoding support
