...
#endif //Version string
#define CYCLONE_CRYPTO_VERSION_STRING "2.0.4"          //Major version
#define CYCLONE_CRYPTO_MAJOR_VERSION 2                 //Minor version
#define CYCLONE_CRYPTO_MINOR_VERSION 0                 //Revision number
#define CYCLONE_CRYPTO_REV_NUMBER 4                    //Multiple precision integer support
#ifndef MPI_SUPPORT  
...
#elif (MPI_ASM_SUPPORT != ENABLED && MPI_ASM_SUPPORT != DISABLED) 88 #error MPI_ASM_SUPPORT parameter is not valid
#endif
//Base64 encoding support
#ifndef BASE64_SUPPORT
#define BASE64_SUPPORT ENABLED
#elif (BASE64_SUPPORT != ENABLED && BASE64_SUPPORT != DISABLED) 95 #error BASE64_SUPPORT parameter is not valid
#endif
